  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 shadow-md">
        ...
        {error && (
          <div className="bg-red-50 text-red-600 p-3 text-sm mb-4 text-center rounded whitespace-pre-wrap leading-relaxed border border-red-100">
            {error}
          </div>
        )}
        ...
        <div className="space-y-4">
           ...
           <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none transition-colors"
          >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <a href="#" className="font-medium text-amber-600 hover:text-amber-500">Forgot your password?</a>
              </div>
            </div>
        ...
        <div className="mt-6 text-center text-sm">
          <span className="text-gray-600">New to Jewelry O'clock? </span>
